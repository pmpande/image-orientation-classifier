...
So we explored resources to know what should be ideal initial weight distribution and what number of hidden layers should be.
We then came up with a solution of initial weight to be random number between (−1/√i,1/√i) where i is the number of input nodes 
and number of hidden nodes to be mean of input and output nodes. But this solution didn't work out well and required long time for training.
